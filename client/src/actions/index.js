...
import { AUTH_USER, UNAUTH_USER, SIGN_IN, NOTES_FETCH, NOTE_ADD,
         NOTE_SELECTED, NOTE_TOGGLE, NOTE_COLLAPSE, WEATHER_FETCH,
         GOALS_FETCH, GOAL_ADD, GOAL_COLLAPSE, GOAL_TOGGLE } from './types';
